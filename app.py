        ...
        try:
            ...
            if raw_ext in ['.png', '.jpg', '.jpeg', '.tiff', '.bmp']:
                try:
                    ...
                    print(f"System Tesseract OCR failed processing tracking: {str(img_err)}")
            ...
            if not markdown_content.strip():
                markdown_content = f"# {filename}\n\nNo readable textual elements could be extracted from this asset layout format."
            ...
            print("Conversion Error Log Tracer:")
            traceback.print_exc()
